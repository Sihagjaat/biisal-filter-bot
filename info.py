...
USERNAME = environ.get('USERNAME', "https://telegram.me/vbkguru")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002386658352'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+o8hZ6VXUpuo2MDZl')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1001959367903')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002367369414'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001959367903'))
